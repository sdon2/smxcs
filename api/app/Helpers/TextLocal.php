...
class TextLocal
{
	 ...
	 * @param $hash
	 */
	function __construct($username = null, $hash = null, $apiKey = false)
	{
	...
	/**
	 * Set error reporting to true to throw errors
	 ...
	 * @param mixed  $custom
	 * @param mixed $optouts
	 * @param mixed $simpleReplyService
	 * @return mixed
	 * @throws Exception
	 */
	...
	public function getBalance()
	{
		...
		return array('sms' => $result->balance->sms ?? 0, 'mms' => $result->balance->mms ?? 0);
	}
