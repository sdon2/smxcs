...
CREATE TABLE IF NOT EXISTS `consignees` (
  ...
  `PaymentTerms` tinyint(3) NOT NULL DEFAULT '2',
  `Remarks` text,
  PRIMARY KEY (`Id`),
...
CREATE TABLE IF NOT EXISTS `consignments` (
  ...
  `LRNumber` int(10) unsigned NOT NULL,
  `ConsignorId` int(10) unsigned NOT NULL,
  ...
  `PaymentMode` tinyint(3) unsigned NOT NULL DEFAULT '1',
  `OGP_Id` int(10) unsigned DEFAULT NULL,
  `Bill_Id` int(10) unsigned DEFAULT NULL,
  `Status` tinyint(3) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `LRNumber` (`LRNumber`),
...
CREATE TABLE IF NOT EXISTS `consignment_logs` (
  ...
  `ConsignmentId` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `sms_logs` (
  ...
  `msgcount` tinyint(4) DEFAULT NULL,
